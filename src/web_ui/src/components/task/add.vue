...
<!--                        <el-select v-model="form.subtasks_id" placeholder="请选子任务" clearable multiple-->
...
<!--                    </el-form-item>-->
                ...
                <el-form :inline="true" :model="form" label-width="170px">
                    ...
                    <el-form-item label="节点选择">
                        <el-select v-model="form.exec_task_node_id" placeholder="请选择节点" clearable multiple
    ...
    export default {
        ...
        methods: {
            ...
            saveTask() {
                ...
                this.$axios
                    .post(_this.$server.task_add, this.form, {})
